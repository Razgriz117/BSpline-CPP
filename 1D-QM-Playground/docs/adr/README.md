...
| [0010](0010-defer-coulomb-tail-continuum-matching.md) | Defer Coulomb-Tail Continuum Matching (Figure 7 Case 2, Non-Flat Sub-Branch) | Accepted (deferred) | `matchAsymptotic` implements only flat-asymptote continuum matching; Coulomb-tail matching (logarithmic phase vs. the flat case's linear phase) required by REQ-F-030 remains undeveloped by any source document. |
...
| [0012](0012-defer-a4-discontinuity-order-verification.md) | Defer Formal Verification of the A4 Derivative-Discontinuity-Order Derivation | Accepted (deferred) | `strategicKnotsFromJoins`'s knot-multiplicity formula is an internal re-derivation, not yet checked against its cited source (`PHY5606_F25_Bsplines_v2.pdf`, not present in this repo — a human needs to add it). |
